                        ...
                        <table class="table-light" aria-describedby="mydesc" class='table-striped' id="table_list"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="payment_gateway" data-align="center" data-sortable="true">{{ __('Payment Gateway') }}
                                    ...
                                    <th scope="col" data-field="created_at" data-align="center" data-sortable="true" data-visible="false"> {{ __('Payment Date') }}
                                    <th scope="col" data-field="updated_at" data-align="center" data-sortable="true" data-visible="false"> {{ __('Payment Update Date') }}
                                </tr>
                            </thead>
                        </table>
                    </div>
