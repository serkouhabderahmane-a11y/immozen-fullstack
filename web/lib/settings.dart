...
class AppSettings {
  ///Basic Settings
  static const String applicationName = 'Immozen';
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  ///Native deep link
  static const String shareNavigationWebUrl = 'https://hzein-technology.com/';
  //ebrokerweb.wrteam.me
  //e-broker-dev001.vercel.app

  // TODO(R): Deprecated [We do not recommend using this as this will stop running in few time]
  /// You will find this prefix from firebase console in dynamic link section
  static const String deepLinkPrefix =
      'https://hzein-technology.com/'; //demo.page.link

  ///set anything you want
  static const String deepLinkName =
      'https://hzein-technology.com/'; //deeplink demo.com
  ///!TODO: End deprecated
