...
import 'package:immozen/ui/screens/chat/chat_list_screen.dart';
import 'package:immozen/ui/screens/home/home_screen.dart';
import 'package:immozen/ui/screens/proprties/my_properties_screen.dart';
import 'package:immozen/ui/screens/userprofile/profile_screen.dart';
...
//This will init page controller
  ...
  Future<void> versionCheck(settings) async {
    var remoteVersion = settings.getSetting(
      defaultTargetPlatform == TargetPlatform.iOS ? SystemSetting.iosVersion : SystemSetting.androidVersion,
    );
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion(
      ...
      child: WillPopScope(
        // canPop: myCanPop() as bool,
        // onPopInvoked: (bool didPop) async {
        onWillPop: () async {
          ///Navigation history
          // didPop = await myCanPop();
          final length = navigationStack.length;
          if (length == 1 && navigationStack[0] == 0) {
            final now = DateTime.now();
            if (currentBackPressTime == null ||
