...
import 'package:immozen/data/model/agent/agents_properties_models/customer_data.dart';
import 'package:immozen/exports/main_export.dart';
import 'package:immozen/ui/screens/agents/agent_properties.dart';
import 'package:immozen/ui/screens/agents/cards/agents_project_card.dart';
  ...
  Widget detailsTab(BuildContext context, CustomerData customerData) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: context.color.inverseSurface.withOpacity(0.05),
            blurRadius: 5,
          ),
        ],
