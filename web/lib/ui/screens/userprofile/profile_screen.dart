...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  String email = 'bderrahmane1999@gmail.com';
  @override
  ...
  Future<void> loadUserData() async {
    ...
    final staticValue = prefs.getInt('static_key') ?? 0;

    if (staticValue == 1) {
      setState(() {
        username = 'serkou';
        email = 'bderrahmane1999@gmail.com';
      });
    } else {
      final user = context.read<UserDetailsCubit>().state.user;
      setState(() {
        username =
            user?.name?.firstUpperCase() ?? 'anonymous'.translate(context);
  ...
  deleteConfirmWidget(String title, String desc, callDel) {
  ...
  void logOutConfirmWidget(BuildContext context) {
    UiUtils.showBlurredDialoge(
      context,
      dialoge: BlurredDialogBox(
