...
class HomePageInfinityScrollCubit extends Cubit<HomePageInfinityScrollState> {
  ...
  Future<void> fetch() async {
    try {
      ...
      final DataOutput<NativeAdWidgetContainer> dataOutput =
          await propertyRepository.fetchAllProperties(
        offset: 0,
      );
      final properties =
          List<NativeAdWidgetContainer>.from(dataOutput.modelList)
              .cast<PropertyModel>();
      /*final DataOutput<PropertyModel> dataOutput =
          await propertyRepository.fetchAllProperties(offset: 0);
      final properties = dataOutput.modelList;*/
